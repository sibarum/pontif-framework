# Pontif: Backward Langauge Design

#. Start by implementing langauge features in the execution AST (Truffle)
...
#. Finally, use the reference language output to guide design of the primary language (sometimes this is called the "alternate langauge" or "alt language").
...
* The langauge syntax should never fight with the runtime implementation. They should fit like a glove.
* The primary language should be thought of as one big syntactic sugar for the reference langauge.
