...
class ParserFactorialTest {
    ...
    private static Object runInterpreter(String src) {
    ...
    private static Object runTruffle(String src) {
        IrModule module = Parser.parseModule(src, "factorial.ptf");
        Simplifier simp = simplifier();
    ...
    @Test
    void factorial_viaMatch_interpreter_yields120() {
        assertEquals(120L, runInterpreter(FACTORIAL_VIA_MATCH));
    }

    @Test
    void factorial_viaMatch_truffle_yields120() {
    ...
    @Test
    void factorial_viaDispatch_interpreter_yields720() {
        assertEquals(720L, runInterpreter(FACTORIAL_VIA_DISPATCH));
    }

    @Test
    void factorial_viaDispatch_truffle_yields720() {
    ...
    @Test
    void module_withSimpleArithmetic_runsOnBothPaths() {
    ...
    @Test
    void module_withLetBinding_runsOnBothPaths() {
    ...
    @Test
    void module_withCallAndLetTogether_runsOnBothPaths() {
        String src = """
                (module sq
    ...
    @Test
    void mutuallyRecursiveEvenOdd_interpreter_yieldsTruthy() {
        // isEven(4) → isOdd(3) → isEven(2) → isOdd(1) → isEven(0) = 1
        assertEquals(1L, runInterpreter(EVEN_ODD));
    }

    @Test
    void mutuallyRecursiveEvenOdd_truffle_yieldsTruthy() {
