...
class LexerTest {
    ...
    @Test
    void positiveAndNegativeIntegers_tokenize() {
    ...
    @Test
    void bareMinusIsASymbol_notAnInteger() {
    ...
    @Test
    void symbols_includeAlphanumericAndOperatorChars() {
    ...
    @Test
    void whitespaceAndNewlines_areSkipped() {
    ...
    @Test
    void semicolonCommentsAreSkipped() {
    ...
    @Test
    void lineAndColumnTrackingAreAccurate() {
        List<Token> ts = tokenize("(\n  hello)");
    ...
    @Test
    void compoundExpression_yieldsExpectedTokenStream() {
    ...
    @Test
    void unsupportedCharacter_throwsWithOrigin() {
